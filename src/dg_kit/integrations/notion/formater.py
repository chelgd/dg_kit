...
class NotionFormater:
    ...
    def _h2(text: str) -> dict:
        return {"object": "block", "type": "heading_2", "heading_2": {"rich_text": [NotionFormater._rt_text(text)]}}


    @staticmethod
    def _para(text: str) -> dict:
        return {"object": "block", "type": "paragraph", "paragraph": {"rich_text": [NotionFormater._rt_text(text)]}}
